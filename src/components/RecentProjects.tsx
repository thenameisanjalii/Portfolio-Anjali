...
const RecentProjects: React.FC<RecentProjectsProps> = ({ id }) => {
  return (
    <section id={id} className="relative w-full py-16">
      <div className="absolute inset-0 dark:bg-transparent bg-gray-50/30 backdrop-blur-3xl"></div>
      <div
        id="projects"
            ...
            >
              <CardContainer className="inter-var">
                <CardBody
                  ...
                  hover:shadow-xl dark:hover:border-white/[0.3] hover:border-black/[0.2]"
                >
                  <CardItem
                    translateZ="50"
                  ...
                  <CardItem
                    as="p"
                    translateZ="60"
                    className="text-gray-600 dark:text-neutral-300 text-sm max-w-sm mt-2"
                  >
                    {item.des}
                  </CardItem>
                  <CardItem translateZ="100" className="w-full mt-4">
                    <img
                      ...
                      className="h-60 w-full object-cover rounded-xl 
                        ...
                        dark:border-white/[0.1] border-black/[0.1] border"
                    />
                  </CardItem>
                  <CardItem translateZ="100" className="w-full mt-4">
                        ...
                        {item.languages.map((tech, index) => (
                          <div key={index} className="relative group/tooltip">
                            ...
                            <div
                              ...
                              px-3 py-1 bg-black/80 dark:bg-white/80 
                              rounded-md text-xs text-white dark:text-black
