...
const Resume: React.FC<ResumeProps> = ({ id }) => {
  ...
  const handleDownload = () => {
    ...
    const googleDriveUrl = import.meta.env.VITE_RESUME_URL;
    ...
    <BackgroundLines>
      <section id={id} className="relative w-full py-16">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold dark:text-white text-theme-neutral-900 mb-6">
            Interested in My Experience?
          </h2>
          <p className="dark:text-theme-neutral-300 text-theme-neutral-600 mb-8 text-lg max-w-2xl mx-auto">
          ...
          <motion.button
            ...
            bg-gradient-to-r from-theme-yellow-600 to-theme-yellow-700 rounded-full
            hover:from-theme-yellow-700 hover:to-theme-yellow-800 transition-all duration-300 shadow-lg
            hover:shadow-theme-yellow-400/20 hover:shadow-xl
