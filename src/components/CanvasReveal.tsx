  ...
  return (
    <div className="text-center flex flex-col items-center">
      <TextGenerateEffect
        ...
        className="text-center lg:text-left text-4xl sm:text-4xl md:text-5xl lg:text-6xl mt-4 mb-4"
      />
      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 mx-auto px-8">
        <Card title="Ideas that Stick" icon={<AceternityIcon />}>
          ...
          />
          <div className="absolute inset-0 opacity-60 bg-gradient-to-br from-emerald-600 to-emerald-900" />
        </Card>
        <Card title="Systems that Scale" icon={<AceternityIcon />}>
          ...
          />
          <div className="absolute inset-0 [mask-image:radial-gradient(400px_at_center,white,transparent)] bg-gradient-to-br from-rose-600 to-purple-900" />
        </Card>
        <Card title="Growth in Every Project" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            ...
            colors={[[125, 211, 252]]}
          />
          <div className="absolute inset-0 bg-gradient-to-br from-sky-400 to-blue-800" />
        </Card>
      </div>
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-lg">
          Driven by clarity and curiosity, I develop scalable, user-focused solutions that solve real problems.
        </p>
      </div>
    </div>
  );
